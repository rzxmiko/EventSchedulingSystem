...
public class Application {
    ...
    public CommandLineRunner demo(EventRepository eventRepo, OrganizerRepository orgRepo) {
        return (args) -> {
            ...
            eventRepo.save(new Event("Startup Battle 2024", 5000.0, org1));
            eventRepo.save(new Event("AI Conference", 15000.0, org1));
            eventRepo.save(new Event("Rock Festival", 25000.0, org2));
            eventRepo.save(new Event("Evening Gala", 8500.0, org2));
            eventRepo.save(new Event("Java Workshop", 0.0, org3));
            eventRepo.save(new Event("DevFest Astana", 3500.0, org3));
            eventRepo.save(new Event("Jazz Night", 1200.0, org4));
            eventRepo.save(new Event("Piano Concert", 4500.0, org4));
            eventRepo.save(new Event("Python for Beginners", 0.0, org5));
            eventRepo.save(new Event("Career Coaching", 12000.0, org5));
